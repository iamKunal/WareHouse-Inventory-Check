...
def arm_and_takeoff_nogps(aTargetAltitude):
    ...
    initial_angle=vehicle.attitude.yaw
    start=time.time()
    print "Arming motors"
    ...
    # vehicle.mode = VehicleMode("GUIDED_NOGPS")
    final_angle=vehicle.attitude.yaw
    print(" Calibrating Back to Initial Yaw")
    set_attitude(yaw_rate=math.degrees(initial_angle-final_angle)/2.0, duration=1)
    time.sleep(1)
...
# vehicle.channels.overrides['3'] = 10000
time.sleep(1)
# print '\a'
